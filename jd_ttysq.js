...
!(async () => {
    ...
    let res = await getAuthorShareCode('https://gitee.com/chanho0/JD-Scripts/raw/master/shareCodes/ttysq2.json')
    if (!res) {
        res = await getAuthorShareCode('https://gitee.com/chanho0/JD-Scripts/raw/master/shareCodes/ttysq2.json')
    }
    if (res) {
