...
ql repo https://github.com/JDHelloWorld/jd_scripts.git "stock|newCron" "" "TS_USER_AGENTS"
ql repo https://github.com/Tsukasa007/my_script.git "wskey|1600|GuangHaoWu" "" "" "master"
