/*
双十一无门槛红包
cron 0 10,12,18 * * *  https://raw.githubusercontent.com/smiek2121/scripts/master/gua_redEnvelopes.js
整点跑 红包几率大点
ck1助力 作者
其余助力ck1
https://u.jd.com/yKjQvTc
跳转到app 可查看助力情况
...
function getUA(){
  ...
  rebateCode = 'yKjQvTc'
  if($.index != 1){
    let arr = [rebateCodes,'yKjQvTc']
    rebateCode = arr[Math.floor(Math.random() * arr.length)] || rebateCode
    if(!rebateCode) rebateCode = 'yKjQvTc'
  }
