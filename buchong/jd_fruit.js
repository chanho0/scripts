...
*/
const $ = new Env('东东农场自用');
let cookiesArr = [], cookie = '', isBox = false, notify,allMessage = '';
//助力好友分享码(最多3个,否则后面的助力失败),原因:京东农场每人每天只有3次助力机会
//此此内容是IOS用户下载脚本到本地使用，填写互助码的地方，同一京东账号的好友互助码请使用@符号隔开。
//下面给出两个账号的填写示例（iOS只支持2个京东账号）

let newShareCodes=['499a71d4d6e540ef8e399c2973f9b779','7a27378dbecf467aa76c6ea776c1676c','39a5e50eb03344c7a2b8652448313873','7191033f2f524f168658051f6b0961ac','79d4ae184398454e821c7c4ba872c234'];
