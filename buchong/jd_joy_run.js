...
[task_local]
# 宠汪汪邀请助力与赛跑助力
50 9 * * * https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_joy_run.js, tag=宠汪汪邀请助力与赛跑助力, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdcww.png, enabled=true
[rewrite_local]
# 宠汪汪助力更新Token
...
*/
process.env.JOY_RUN_HELP_MYSELF = true
const $ = new Env('宠汪汪赛跑');
...
//下面给出好友邀请助力的示例填写规则
let invite_pins = ['306473061_m,jd_701c0965eabd0,jd_504f8ca4bc76b'];
//下面给出好友赛跑助力的示例填写规则
let run_pins = ['306473061_m,jd_701c0965eabd0,jd_504f8ca4bc76b'];
//friendsArr内置太多会导致IOS端部分软件重启,可PR过来(此处目的:帮别人助力可得30g狗粮)
let friendsArr = ["306473061_m", "jd_701c0965eabd0", "jd_504f8ca4bc76b"]
    ...
    if (cookiesArr[i]) {
      ...
      if ($.isNode()) {
        if (process.env.JOY_RUN_HELP_MYSELF) {
          ...
          let fixPins = run_pins.splice(run_pins.indexOf('306473061_m'), 1);
          // fixPins.push(...run_pins.splice(run_pins.indexOf('jd_701c0965eabd0'), 1));
