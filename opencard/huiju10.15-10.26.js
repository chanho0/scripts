...
!(async () => {
    ...
    authorCodeList = await getAuthorCodeList('https://raw.githubusercontent.com/FKPYW/dongge/master/code/lzdz1_huanju.json')
    if(authorCodeList === '404: Not Found'){
        authorCodeList = [
            'c2524caa6ba64a2ca704efe2605a8a46',
        ]
    }
...
async function member() {
    ...
    if ($.token) {
        ...
        if ($.secretPin) {
            ...
            await $.wait(1000)
            // $.log("->流览")
            // await task('linkgame/browseGoods', `activityId=${$.activityId}&pin=${encodeURIComponent($.secretPin)}&value=100005181884`)
            ...
            // await $.wait(1000)
            // await task('linkgame/browseGoods', `activityId=${$.activityId}&pin=${encodeURIComponent($.secretPin)}&value=10037104391438`)
            // await task('interaction/write/writePersonInfo', `jdActivityId=${$.jdActivityId}&pin=${encodeURIComponent($.secretPin)}&actionType=5&venderId=${$.venderId}&activityId=${$.activityId}`,1)
            // await $.wait(1000)
            // await task('linkgame/browseGoods', `activityId=${$.activityId}&pin=${encodeURIComponent($.secretPin)}&value=100023800832`)
            // await task('interaction/write/writePersonInfo', `jdActivityId=${$.jdActivityId}&pin=${encodeURIComponent($.secretPin)}&actionType=5&venderId=${$.venderId}&activityId=${$.activityId}`,1)
            // await $.wait(1000)
            // await task('linkgame/browseGoods', `activityId=${$.activityId}&pin=${encodeURIComponent($.secretPin)}&value=6930866`)
            // await task('interaction/write/writePersonInfo', `jdActivityId=${$.jdActivityId}&pin=${encodeURIComponent($.secretPin)}&actionType=5&venderId=${$.venderId}&activityId=${$.activityId}`,1)
            // await $.wait(1000)
            // await task('linkgame/browseGoods', `activityId=${$.activityId}&pin=${encodeURIComponent($.secretPin)}&value=100025643292`)
            // await task('interaction/write/writePersonInfo', `jdActivityId=${$.jdActivityId}&pin=${encodeURIComponent($.secretPin)}&actionType=5&venderId=${$.venderId}&activityId=${$.activityId}`,1)
            // await $.wait(1000)
            // await task('linkgame/browseGoods', `activityId=${$.activityId}&pin=${encodeURIComponent($.secretPin)}&value=100018084866`)
            // await task('interaction/write/writePersonInfo', `jdActivityId=${$.jdActivityId}&pin=${encodeURIComponent($.secretPin)}&actionType=5&venderId=${$.venderId}&activityId=${$.activityId}`,1)
            // await $.wait(1000)
        }
    }
