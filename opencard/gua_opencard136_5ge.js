...
let guaopenwait = '0'
process.env.guaopencard136 = true
...
!(async () => {
    ...
    $.shareUuid = '0a98e4fca9a54d999fe21a8ef17e1ed2'
    ...
    try {
        ...
        if(!$.addSku && !$.outFlag){
            if(guaopencard_addSku+'' == 'true'){
                ...
                if(cleanCart){
                    ...
                    if(goodsArr !== false) await $.wait(parseInt(Math.random() * 1000, 10))
                }
        ...
        if(guaopenwait){
            if($.index != cookiesArr.length){
                ...
                await $.wait(parseInt(guaopenwait, 10))
            }
        }else{
